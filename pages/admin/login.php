...
<head>
    ...
    <link rel="stylesheet" href="D:\xampp\htdocs\Bus reservation\css\login.css">
    <link rel="stylesheet" href="D:\xampp\htdocs\Bus reservation\css\style2.css">
    ...
    <div class="message-box">
        ...
        <div class="buttons-con">
            ...
            <div>   
              ...
              <input type="submit" value="Login" class="submitBtn" id="userSubmitBtn" name="login" onclick="naviagtereg()"> </input>
                </div>
            </div>   
            </form>
            </div>
        ...
        {  
            ...
            $q = "select * from admin where email = '$emailid' AND password = '$password'"; 
            $result = $dbh->query($q);
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                session_start();
                $_SESSION["usersessionvar"] = $row["email"] . "|" . $row["password"];
